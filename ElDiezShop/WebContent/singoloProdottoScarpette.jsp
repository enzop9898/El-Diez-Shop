...
<!--  <link rel="stylesheet" type="text/css" href="STILI/bootstrap.min.css">-->
    ...
    <script src="scarpette.js"></script> 
    <link rel="icon" href="foto/logoDef.png" sizes="9x9">
    <meta charset="UTF-8">
	<title>Dettagli Scarpette</title>
</head>
<body>
          ...
          <div class="p-4">
            ...
            <form action="ProductControl" method="get" onsubmit="return controlloTaglia()">
              <div class="d-flex justify-content-left">
                  ...
                  <button type="button" class="btn btn-dark taglie" id="b1" onclick="cambioTaglia41()">41</button>
                  <button type="button" class="btn btn-dark taglie" id="b2" onclick="cambioTaglia42()">42</button>
                  <button type="button" class="btn btn-dark taglie" id="b3" onclick="cambioTaglia43()">43</button>
                  <p id="errore"></p>
                  <p id="flag"></p>
              ...
              <br>
                                <p> <b>Non sei sicuro del numero perfetto per te? </b> <br> Tranquillo,abbiamo pensato anche a quello,visita la nostra <a href="taglia home.html">Tabella delle Taglie</a> </p>
              <br>
              <div class="d-flex justify-content-left">
